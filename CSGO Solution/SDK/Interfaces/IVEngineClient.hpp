...
#include "../Game/MapOverview.hpp"
#include "../Game/NetChannelInfo.hpp"
...
public:
	...
	virtual bool                  GetPlayerInfo(int ent_num, C_PlayerInfo* pinfo) = 0;
	...
	virtual C_NetChannelInfo*	  GetNetChannelInfo(void) = 0;
	virtual void                  DebugDrawPhysCollide(const void* pCollide, void* pMaterial, const matrix3x4_t& transform, const uint8_t* color) = 0; //79
	...
	virtual void                  RegisterDemoCustomDataCallback(const char* szCallbackSaveID, uint32_t pCallback) = 0;
	virtual void                  RecordDemoCustomData( uint32_t pCallback, const void* pData, size_t iDataLength) = 0;
	...
	virtual void                  SolidMoved(class C_ClientEntity* pSolidEnt, class ICollideable* pSolidCollide, const Vector* pPrevAbsOrigin, bool accurateBboxTriggerChecks) = 0;
	virtual void                  TriggerMoved(class C_ClientEntity* pTriggerEnt, bool accurateBboxTriggerChecks) = 0;
	...
	virtual uint32_t			  GetInputContext(int /*EngineInputContextId_t*/ id) = 0;
	...
	{
		auto pNetChannel = GetNetChannelInfo();

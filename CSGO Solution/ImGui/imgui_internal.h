...
struct ImGuiContext
{
    ...
    ImDrawList              OverlayDrawList;                    // First draw list to be rendered.
    ...
    ImGuiContext(ImFontAtlas* shared_font_atlas) : OverlayDrawList(&DrawListSharedData), ForegroundDrawList(&DrawListSharedData)
    {
        Initialized = false;

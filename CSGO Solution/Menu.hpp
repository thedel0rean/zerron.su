...
public:
	...
	virtual void DrawLuaTab();
	virtual void DrawColorEdit4( const char* strLabel, Color* aColor, int expand = 70 );
...
private:
	...
	std::string m_strMenuName = _S( "SELLING" );
	std::string preview = _S("None");

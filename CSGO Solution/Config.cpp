...
//
//	for (int i = 0; i < 5; i++)
//		jManual[_S("Logs")][std::to_string(i)] = g_Settings->m_aLogs[i];
//
//	for (int i = 0; i < 3; i++)
//	{
...
//
//	for (int x = 0; x < 6; x++)
//		jManual[_S("Flags m_LocalPlayer")][std::to_string(x)] = g_Settings->m_LocalPlayer.GetPtr()->m_Flags[x];
//
//	for (int x = 0; x < 6; x++)
//		jManual[_S("Flags m_Teammates")][std::to_string(x)] = g_Settings->m_Teammates.GetPtr()->m_Flags[x];
//
//	for (int x = 0; x < 6; x++)
//		jManual[_S("Flags m_Enemies")][std::to_string(x)] = g_Settings->m_Enemies.GetPtr()->m_Flags[x];
//
...
//	}
//
//	SET_COLOR(jManual[_S("WorldColors")][_S("WorldColor")], g_Settings->m_WorldModulation);
//	SET_COLOR(jManual[_S("WorldColors")][_S("PropColor")], g_Settings->m_PropModulation);
//	SET_COLOR(jManual[_S("WorldColors")][_S("SkyboxColor")], g_Settings->m_SkyModulation);
//	SET_COLOR(jManual[_S("Impacts")][_S("ClientColor")], g_Settings->m_ClientImpacts);
//	SET_COLOR(jManual[_S("Impacts")][_S("ServerColor")], g_Settings->m_ServerImpacts);
//	
//
...
//
//	for (int i = 0; i < 5; i++)
//		g_Settings->m_aLogs[i] = jManual[_S("Logs")][std::to_string(i)].get < bool >();
//
//
//	for (int i = 0; i < 6; i++)
//		g_Settings->m_LocalPlayer.GetPtr()->m_Flags[i] = jManual[_S("Flags m_LocalPlayer")][std::to_string(i)].get < bool >();
//
//	for (int i = 0; i < 6; i++)
//		g_Settings->m_Teammates.GetPtr()->m_Flags[i] = jManual[_S("Flags m_Teammates")][std::to_string(i)].get < bool >();
//
//	for (int i = 0; i < 6; i++)
//		g_Settings->m_Enemies.GetPtr()->m_Flags[i] = jManual[_S("Flags m_Enemies")][std::to_string(i)].get < bool >();
//
//	for (int i = 0; i < 3; i++)
...
//	}
//
//	LOAD_COLOR(jManual[_S("WorldColors")][_S("WorldColor")], g_Settings->m_WorldModulation);
//	LOAD_COLOR(jManual[_S("WorldColors")][_S("PropColor")], g_Settings->m_PropModulation);
//	LOAD_COLOR(jManual[_S("WorldColors")][_S("SkyboxColor")], g_Settings->m_SkyModulation);
//	LOAD_COLOR(jManual[_S("Impacts")][_S("ClientColor")], g_Settings->m_ClientImpacts);
//	LOAD_COLOR(jManual[_S("Impacts")][_S("ServerColor")], g_Settings->m_ServerImpacts);
//}
...
void C_World::Clantag( )
{
	...
	if (!g_Settings->m_bClantag && !removed)
	{
		removed = true;
		apply(_S(""));
		return;
	...
	if (g_Settings->m_bClantag)
	{
		...
		if (main_time != time && !g_Globals.m_Interfaces.m_ClientState->m_nChokedCommands( ) )
		{
			...
			case 1: tag = "c"; break;
			case 2: tag = "ch"; break;
			case 3: tag = "che"; break;
			case 4: tag = "chea"; break;
			case 5: tag = "cheat"; break;
			case 6: tag = "cheat_"; break;
			case 7: tag = "cheat_t"; break;
			case 8: tag = "cheat_te"; break;
			case 9: tag = "cheat_tes"; break;
			case 10: tag = "cheat_test"; break;
			case 11: tag = "cheat_test"; break;
			case 12: tag = "cheat_tes"; break;
			case 13: tag = "cheat_te"; break;
			case 14: tag = "cheat_t"; break;
			case 15: tag = "cheat_"; break;
			case 16: tag = "cheat"; break;
			case 17: tag = "chea"; break;
			case 18: tag = "che"; break;
			case 19: tag = "ch"; break;
			case 20: tag = "c"; break;
			case 21: tag = ""; break;
			}

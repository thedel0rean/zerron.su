...
public:
	...
	virtual int GetDesyncSideByPlaybackrate(C_BasePlayer* pPlayer, C_LagRecord& LagRecord, C_LagRecord PreviousRecord, bool bHasPreviousRecord);
	virtual void RebuildSixLayer(C_BasePlayer* pPlayer, C_LagRecord& LagRecord, int rotation, float delta);

	//virtual int GetDesyncSideByDeltaWeight(C_BasePlayer* pPlayer, C_LagRecord& LagRecord, C_LagRecord PreviousRecord, bool bHasPreviousRecord);
	//virtual int GetDesyncSideByNearestDelta(C_BasePlayer* pPlayer, C_LagRecord& LagRecord, C_LagRecord PreviousRecord, bool bHasPreviousRecord);
	virtual int GetDesyncSideByFreestand(C_BasePlayer* pPlayer, C_LagRecord& LagRecord, C_LagRecord PreviousRecord, bool bHasPreviousRecord);
private:

...
void C_Render::ReloadFonts( )
{
	...
	g_Globals.m_Fonts.m_LogIcons = ImGui::GetIO().Fonts->AddFontFromMemoryCompressedTTF(LogIcons_compressed_data, LogIcons_compressed_size, 12.0f, &cfg);
...
void C_Render::AddConvexPolyFilled(const ImVec2* points, const int points_count, ImU32 col)
{
	m_DrawList->AddConvexPolyFilled(points, points_count, col);
}

...
struct C_ChamsSettings
{
	...
	bool m_aModifiers[ 5 ] = { false, false, false, false, false };

	Color m_aModifiersColors[ 5 ] = { { 255, 255, 255, 255 }, { 255, 255, 255, 255 }, { 255, 255, 255, 255 }, { 255, 255, 255, 255 }, { 255, 255, 255, 255 } };
...
struct C_PlayerSettings
{
	...
	bool m_Flags[5] = { false, false, false, false, false };
};
...
public:
	...
	Color m_aProjectileGlow = Color( 255, 255, 255, 255 );
	Color m_WorldModulation = Color( 255, 255, 255, 255 );
	Color m_PropModulation = Color( 255, 255, 255, 255 );
	Color m_SkyModulation = Color( 255, 255, 255, 255 );
	Color m_ClientImpacts = Color( 255, 255, 255, 255 );
	Color m_ServerImpacts = Color( 255, 255, 255, 255 );
	Color m_LocalTracers = Color( 255, 255, 255, 255 );
	Color m_EnemyTracers = Color( 255, 255, 255, 255 );
	Color m_GrenadeWarning = Color( 255, 255, 255, 255 );
	Color m_GrenadeWarningTimer = Color( 255, 255, 255, 255 );
	Color m_aC4Glow = Color( 255, 255, 255, 255 );
	Color m_aDroppedWeaponGlow = Color( 255, 255, 255, 255 );
	Color m_aOutOfViewArrows = Color( 255, 255, 255, 255 );
	...
	bool m_aWorldRemovals[10] = { false, false, false, false, false, false, false, false, false, false};
	...
	bool m_aInverterConditions[3] = {false, false, false};
	bool m_aLogs[5] = { false, false, false, false, false };
	// fakelag triggers
	// 0 - Move
	// 1 - Air
	// 2 - Peek
	//std::array < bool, 3 > m_aFakelagTriggers = { };
	bool m_aFakelagTriggers[3] = { false, false, false };
	// rage settings
	// 0 - Autosniper
	// 1 - Scout
	// 2 - AWP
	...
	std::array < wskin, 100 > m_aInventory = { };
	...
	bool m_aEquipment[7] = { false, false, false, false, false, false, false};
